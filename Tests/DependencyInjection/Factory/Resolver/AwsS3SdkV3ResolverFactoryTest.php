...
/**
 * @covers Liip\ImagineBundle\DependencyInjection\Factory\Resolver\AwsS3SdkV3ResolverFactory<extended>
 */
class AwsS3SdkV3ResolverFactoryTest extends \Phpunit_Framework_TestCase
{
    public function testImplementsResolverFactoryInterface()
    {
        $rc = new \ReflectionClass('Liip\ImagineBundle\DependencyInjection\Factory\Resolver\AwsS3SdkV3ResolverFactory');
    ...
    public function testReturnExpectedName()
    {
        ...
        $this->assertEquals('aws_s3_sdk_v3', $resolver->getName());
    }
     ...
     * @expectedExceptionMessage The child node "bucket" at path "aws_s3_sdk_v3" must be configured.
     */
    public function testThrowBucketNotSetOnAddConfiguration()
    {
        $treeBuilder = new TreeBuilder();
        $rootNode = $treeBuilder->root('aws_s3_sdk_v3', 'array');
    ...
    /**
     * @expectedException \Symfony\Component\Config\Definition\Exception\InvalidConfigurationException
     * @expectedExceptionMessage The child node "client_config" at path "aws_s3_sdk_v3" must be configured.
     */
    ...
    /**
     * @expectedException \Symfony\Component\Config\Definition\Exception\InvalidConfigurationException
     * @expectedExceptionMessage Invalid type for path "aws_s3_sdk_v3.client_config". Expected array, but got string
     */
