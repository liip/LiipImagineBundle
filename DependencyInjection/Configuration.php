            ...
            ->children()
                ...
                ->arrayNode('controller')
                    ...
                    ->children()
                        ...
                        ->booleanNode('debug')
                            ->defaultNull()
                            ->info('Whether to report images that can not be generated as an error. Defaults to the kernel debug mode. When disabled, the default image is served instead, if one is configured.')
                        ->end()
                    ->end()
                ->end()
