            ...
            ->children()
                ...
                ->arrayNode('controller')
                    ...
                    ->children()
                        ...
                        ->scalarNode('runtime_config_action')->defaultValue('liip_imagine.controller:runtimeConfigAction')->end()
                    ->end()
                ->end()
                    ...
                    ->prototype('array')
                        ...
                        ->children()
                            ...
                            ->arrayNode('controller')
                                ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('filter_action')->defaultNull()->end()
                                    ->scalarNode('runtime_config_action')->defaultNull()->end()
                                ->end()
                            ->end()
                            ->arrayNode('route')
                                ->defaultValue(array())
